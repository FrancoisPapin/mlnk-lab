// MLKN.lab — Anthropology Knowledge Network Data
...
const CLUSTERS = {
  CULTURAL: { label:"Cultural Anthropology", color:"#C0392B", light:"#FDF0EF" },
  BIOANTH: { label:"Biological Anthropology", color:"#1A6BAA", light:"#EBF4FB" },
  LINGAUTH: { label:"Linguistic Anthropology", color:"#B7770D", light:"#FEF9EE" },
  ARCHAEO: { label:"Archaeology", color:"#1A8A4A", light:"#EAFAF1" },
  MEDICAL: { label:"Medical Anthropology", color:"#7D3C98", light:"#F5EEF8" },
  ECOANTH: { label:"Ecological Anthropology", color:"#0A7E8C", light:"#E8F8FA" },
  POLITANH: { label:"Political Anthropology", color:"#C05718", light:"#FDF3EE" },
  APPLIED: { label:"Applied Anthropology", color:"#1A4A7A", light:"#EBF2FA" },
};
...
// See: /home/claude/mlkn-lab/networks/anthropology.html
